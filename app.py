...
if st.session_state.vector_store is not None:
    ...
    file_can_loc = st.selectbox("Lọc tìm kiếm theo tài liệu (Tùy chọn): ", ["Toàn bộ tài liệu"] + danh_sach_file)
    ...
    with col_adv2:
        #câu 10:
        use_self_rag = st.checkbox("Bật Self-RAG để LLM tự đánh giá và chọn lọc tài liệu phù hợp với câu hỏi.", help="tự đông tối ưu câu hỏi và tự đánh giá (Confidence Score)")
